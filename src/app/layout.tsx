...
export const metadata: Metadata = {
  title: "Jio Toys | Premium Toys for Kids & Families",  description: "Discover handpicked, safe, and creative toys for children at Jio. Fast shipping, quality guaranteed, and 30-day returns. Shop now!",  keywords: "toys for kids, children toys, premium toys, educational toys, safe toys, toy store",  openGraph: {
    title: "Jio Toys | Premium Toys for Kids & Families",    description: "Discover handpicked, safe, and creative toys for children. Fast shipping and quality guaranteed.",    siteName: "Jio Toys",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/elevated-view-two-boys-gathering-confetti-wooden-floor_23-2148046178.jpg",        alt: "Jio Toys - Premium toys for kids"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Jio Toys | Premium Toys for Kids & Families",    description: "Discover handpicked, safe, and creative toys for children",    images: ["http://img.b2bpic.net/free-photo/elevated-view-two-boys-gathering-confetti-wooden-floor_23-2148046178.jpg"]
  },
  robots: {
    index: true,
    follow: true
